const RatingBar = () => {
  ...
  return (
    <div className="flex flex-col mx-20 border-t border-b pb-10 border-gray-300 pt-14 ">
      <div className="flex">
        <img src="/ui-images/star.svg" className="w-6 h-6" alt="" />
        <span className="text-2xl font-medium mb-10">4.89 · 241 reviews</span>
      </div>
      <div className="flex">
        <div className="flex flex-col border-r border-gray-300">
          <span className="text-sm font-medium">Overall rating</span>
          <img src="/ui-images/ratings.png" alt="" className="w-44 -ml-3 mt-1" />
        </div>
        <div className="flex flex-col font-medium w-[9.6rem] ml-6 border-r border-gray-300">
          <span>Cleanliness</span>
          <span className="mb-7">4.9</span>
          <svg
        ...
        <div className="flex flex-col font-medium w-36 border-r ml-6 border-gray-300">
          <span>Accuracy</span>
          <span className="mb-7">4.8</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 32 32"
            aria-hidden="true"
        ...
        <div className="flex flex-col font-medium w-36 ml-6 ">
          <span>Value</span>
          <span className="mb-7">4.8</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
