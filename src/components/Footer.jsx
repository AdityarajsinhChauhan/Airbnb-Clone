...
const Footer = ({message}) => {
  return (
    <div onClick={message} className='flex flex-col w-[100vw] bg-gray-50 pb-12'>

      {/* first section */}
      <div className="ml-10 pt-14  flex text-2xl font-medium mb-8 ">
      Inspiration for future getaways
      </div>
      <div className="flex text-sm mx-10 pb-3 text-gray-600 border-b border-gray-300">
        <span className='mr-6 cursor-pointer'>Popular</span>
        <span className='mr-6 cursor-pointer'>Arts & culture</span>
        <span className='mr-6 cursor-pointer'>Outdoors</span>
        <span className='mr-6 cursor-pointer'>Mountains</span>
        <span className='mr-6 cursor-pointer'>Beach</span>
        <span className='mr-6 cursor-pointer'>Unique stays</span>
        <span className='text-black mr-6 pb-3 -mb-3 border-b-2 border-black'>Categories</span>
        <span className='mr-6 cursor-pointer'>Things to do</span>
      </div>
      <div className="flex text-sm font-medium ml-10">
        <div className='flex flex-col w-1/6'>
          <span className='mt-5 cursor-pointer'>Amazing pools</span>
          <span className='mt-5 cursor-pointer'>Countyside</span>
          <span className='mt-5 cursor-pointer'>OMG!</span>
        </div>

        <div className='flex flex-col w-1/6'>
          <span className='mt-5 cursor-pointer'>Arctic</span>
          <span className='mt-5 cursor-pointer'>Design</span>
          <span className='mt-5 cursor-pointer'>Tiny homes</span>
        </div>

        <div className='flex flex-col w-1/6'>
          <span className='mt-5 cursor-pointer'>Camping</span>
          <span className='mt-5 cursor-pointer'>Earth homes</span>
          <span className='mt-5 cursor-pointer'>Towers</span>
        </div>

        <div className='flex flex-col w-1/6'>
          <span className='mt-5 cursor-pointer'>Camper vans</span>
          <span className='mt-5 cursor-pointer'>Farms</span>
          <span className='mt-5 cursor-pointer'>Windmills</span>
        </div>

        <div className='flex flex-col w-1/6'>
          <span className='mt-5 cursor-pointer'>Castles</span>
          <span className='mt-5 cursor-pointer'>National Parks</span>
          <span className='mt-5 cursor-pointer'>Luxe</span>
        </div>

        <div className='flex flex-col w-1/6'>
          <span className='mt-5 cursor-pointer'>Containers</span>
          <span className='mt-5 cursor-pointer'>Vine yards</span>
          <span className='mt-5 cursor-pointer'></span>
        </div>
      </div>

       {/* second section */}

       <div className="flex border-t pt-12 mt-12 border-b border-gray-300 pb-10">
